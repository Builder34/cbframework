...
<head>
  ...
  <!-- bootstrap - css -->
  <link href="statics/BJUI_3rdPlugin/BJUI/themes/css/bootstrap.css" rel="stylesheet">
  <!-- core - css -->
  <link href="statics/BJUI_3rdPlugin/BJUI/themes/css/style.css" rel="stylesheet">
  <link href="statics/BJUI_3rdPlugin/BJUI/themes/blue/core.css" id="bjui-link-theme" rel="stylesheet">
  <!-- plug - css -->
  <link href="statics/BJUI_3rdPlugin/BJUI/plugins/kindeditor_4.1.10/themes/default/default.css" rel="stylesheet">
  <link href="statics/BJUI_3rdPlugin/BJUI/plugins/colorpicker/css/bootstrap-colorpicker.min.css" rel="stylesheet">
  <link href="statics/BJUI_3rdPlugin/BJUI/plugins/niceValidator/jquery.validator.css" rel="stylesheet">
  <link href="statics/BJUI_3rdPlugin/BJUI/plugins/bootstrapSelect/bootstrap-select.css" rel="stylesheet">
  <link href="statics/BJUI_3rdPlugin/BJUI/themes/css/FA/css/font-awesome.min.css" rel="stylesheet">
  <!--[if lte IE 7]>
  <link href="statics/BJUI_3rdPlugin/BJUI/themes/css/ie7.css" rel="stylesheet">
  <![endif]-->
  <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
  <!--[if lte IE 9]>
  <script src="statics/BJUI_3rdPlugin/BJUI/other/html5shiv.min.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/other/respond.min.js"></script>
  <![endif]-->
  <!-- jquery -->
  <script src="statics/BJUI_3rdPlugin/BJUI/js/jquery-1.7.2.min.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/js/jquery.cookie.js"></script>
  <!--[if lte IE 9]>
  <script src="statics/BJUI_3rdPlugin/BJUI/other/jquery.iframe-transport.js"></script>
  <![endif]-->
  <!-- BJUI.all 分模块压缩版 -->
  <script src="statics/BJUI_3rdPlugin/BJUI/js/bjui-all.js"></script>
  <!-- 以下是B-JUI的分模块未压缩版，建议开发调试阶段使用下面的版本 -->
  <!--
  <script src="statics/BJUI_3rdPlugin/BJUI/js/bjui-core.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/js/bjui-regional.zh-CN.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/js/bjui-frag.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/js/bjui-extends.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/js/bjui-basedrag.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/js/bjui-slidebar.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/js/bjui-contextmenu.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/js/bjui-navtab.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/js/bjui-dialog.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/js/bjui-taskbar.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/js/bjui-ajax.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/js/bjui-alertmsg.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/js/bjui-pagination.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/js/bjui-util.date.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/js/bjui-datepicker.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/js/bjui-ajaxtab.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/js/bjui-datagrid.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/js/bjui-tablefixed.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/js/bjui-tabledit.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/js/bjui-spinner.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/js/bjui-lookup.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/js/bjui-tags.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/js/bjui-upload.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/js/bjui-theme.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/js/bjui-initui.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/js/bjui-plugins.js"></script>
  -->
  <!-- plugins -->
  <!-- swfupload for uploadify && kindeditor -->
  <script src="statics/BJUI_3rdPlugin/BJUI/plugins/swfupload/swfupload.js"></script>
  <!-- kindeditor -->
  <script src="statics/BJUI_3rdPlugin/BJUI/plugins/kindeditor_4.1.10/kindeditor-all.min.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/plugins/kindeditor_4.1.10/lang/zh_CN.js"></script>
  <!-- colorpicker -->
  <script src="statics/BJUI_3rdPlugin/BJUI/plugins/colorpicker/js/bootstrap-colorpicker.min.js"></script>
  <!-- ztree -->
  <script src="statics/BJUI_3rdPlugin/BJUI/plugins/ztree/jquery.ztree.all-3.5.js"></script>
  <!-- nice validate -->
  <script src="statics/BJUI_3rdPlugin/BJUI/plugins/niceValidator/jquery.validator.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/plugins/niceValidator/jquery.validator.themes.js"></script>
  <!-- bootstrap plugins -->
  <script src="statics/BJUI_3rdPlugin/BJUI/plugins/bootstrap.min.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/plugins/bootstrapSelect/bootstrap-select.min.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/plugins/bootstrapSelect/defaults-zh_CN.min.js"></script>
  <!-- icheck -->
  <script src="statics/BJUI_3rdPlugin/BJUI/plugins/icheck/icheck.min.js"></script>
  <!-- dragsort -->
  <script src="statics/BJUI_3rdPlugin/BJUI/plugins/dragsort/jquery.dragsort-0.5.1.min.js"></script>
  <!-- HighCharts -->
  <script src="statics/BJUI_3rdPlugin/BJUI/plugins/highcharts/highcharts.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/plugins/highcharts/highcharts-3d.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/plugins/highcharts/themes/gray.js"></script>
  <!-- ECharts -->
  <script src="statics/BJUI_3rdPlugin/BJUI/plugins/echarts/echarts.js"></script>
  <!-- other plugins -->
  <script src="statics/BJUI_3rdPlugin/BJUI/plugins/other/jquery.autosize.js"></script>
  <link href="statics/BJUI_3rdPlugin/BJUI/plugins/uploadify/css/uploadify.css" rel="stylesheet">
  <script src="statics/BJUI_3rdPlugin/BJUI/plugins/uploadify/scripts/jquery.uploadify.min.js"></script>
  <script src="statics/BJUI_3rdPlugin/BJUI/plugins/download/jquery.fileDownload.js"></script>

  <!-- init -->
  <script type="text/javascript">
    $(function() {
      BJUI.init({
        JSPATH       : 'statics/BJUI_3rdPlugin/BJUI/',         //[可选]框架路径
        PLUGINPATH   : 'statics/BJUI_3rdPlugin/BJUI/plugins/', //[可选]插件路径
  ...
  <!-- for doc begin -->
  <link type="text/css" rel="stylesheet" href="statics/BJUI_3rdPlugin/js/syntaxhighlighter-2.1.382/styles/shCore.css"/>
  <link type="text/css" rel="stylesheet" href="statics/BJUI_3rdPlugin/js/syntaxhighlighter-2.1.382/styles/shThemeEclipse.css"/>
  <script type="text/javascript" src="statics/BJUI_3rdPlugin/js/syntaxhighlighter-2.1.382/scripts/brush.js"></script>
  <link href="doc/doc.css" rel="stylesheet">
  <script type="text/javascript">
    $(function(){
      SyntaxHighlighter.config.clipboardSwf = 'statics/BJUI_3rdPlugin/js/syntaxhighlighter-2.1.382/scripts/clipboard.swf'
...
<div id="bjui-window">
  <header id="bjui-header">
    <div class="bjui-navbar-header">
      ...
      <a class="bjui-navbar-logo" href="#"><img src="statics/BJUI_3rdPlugin/images/logo.png"></a>
    </div>
      ...
      <div class="tabsPageHeader">
        <div class="tabsPageHeaderContent">
          <ul class="navtab-tab nav nav-tabs">
            <li data-url="statics/index_layout.html" data-faicon="home"><a href="javascript:;"><span><i class="fa fa-home"></i> #maintab#</span></a></li>
          </ul>
        </div>
  ...
  <footer id="bjui-footer">Copyright &copy; 2013 - 2015　<a href="#" target="_blank">吖彪快跑34</a>　
  </footer>
</div>
</body>
</html>
